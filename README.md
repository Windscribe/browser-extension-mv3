...
and use the credentials from that account here for the `build password and username`. This is needed to fetch locations at build time and embed generated content scripts.
