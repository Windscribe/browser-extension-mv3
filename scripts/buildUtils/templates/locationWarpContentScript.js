function locationWarpContentScriptTemplate(coords) {
  return `
      ...
      argumentsList[0] = function (position: GeolocationPosition) {
        const spoofCoordinatesFor = (obj: GeolocationCoordinates): void => {
          Object.defineProperty(obj, 'latitude', {
            value: ${coords.latitude ? +coords.latitude : null},
          })
          Object.defineProperty(obj, 'longitude', {
            value: ${coords.longitude ? +coords.longitude : null},
          })
...
module.exports = locationWarpContentScriptTemplate
