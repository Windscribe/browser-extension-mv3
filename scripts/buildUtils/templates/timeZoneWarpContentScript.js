function timeZoneWarpContentScriptTemplate(options) {
  return `
  ;(() => {
...
propertyNames.forEach(function (name) {
  if (
    ['setHours', 'setMinutes', 'setMonth', 'setDate', 'setYear', 'setFullYear'].indexOf(name) !== -1
  ) {
...
module.exports = timeZoneWarpContentScriptTemplate
