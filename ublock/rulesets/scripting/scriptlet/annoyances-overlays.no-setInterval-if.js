...
const argsList = ["[\".parentNode.removeChild\"]","[\"nagScroll\"]","[\"height\"]","[\"0x\"]","[\"debugger\"]","[\"visibility\",\"1000\"]","[\"pushAd\"]","[\"removeChild\"]","[\"modal\"]","[\"_0x\"]","[\"clearInterval(loginReady)\"]","[\"offsetHeight\"]","[\"adsbygoogle\"]","[\"dfgh-adsbygoogle\"]","[\"/_0x|devtools/\"]","[\"potato\"]","[\"detect\"]"];
