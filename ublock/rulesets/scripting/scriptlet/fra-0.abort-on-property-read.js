...
const argsList = [{"a":["Object.prototype.autoRecov"]},{"a":["gothamBatAdblock"]},{"a":["mdpDeBlocker"]},{"a":["adsurgeNode"]},{"a":["zoneSett"]},{"a":["__yget_ad_list"]},{"a":["_adb"]}];

const hostnamesMap = new Map([["radio.fr",0],["vostfr.stream",1],["9docu.org",1],["bleachmx.fr",2],["filmstreamy.com",3],["11anim.com",4],["basketusa.com",5],["lindependant.fr",6]]);
