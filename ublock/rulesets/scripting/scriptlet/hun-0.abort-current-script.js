...
const argsList = [{"a":["window._ceCTSData","hirdetések"]},{"a":["document.head","currentScript.remove"]},{"a":["document.addEventListener","ai_run_"]},{"a":["document.getElementById","ai_run_"]},{"a":["document.createElement","setTimeout"]}];

const hostnamesMap = new Map([["24.hu",0],["divany.hu",1],["totalcar.hu",1],["totalbike.hu",1],["magyarhang.org",[2,3]],["hang.hu",[2,3]],["napiszar.com",4]]);
