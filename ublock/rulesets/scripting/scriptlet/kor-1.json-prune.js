...
const argsList = [{"a":["text_banner image_banner"]},{"a":["[].displayBeginDate [].displayEndDate"]},{"a":["shopping"]},{"a":["ads"]}];

const hostnamesMap = new Map([["op.gg",0],["11st.co.kr",1],["m.nate.com",2],["shoppinghow.kakao.com",3]]);
