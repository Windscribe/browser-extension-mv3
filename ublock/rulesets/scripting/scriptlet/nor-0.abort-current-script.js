...
const argsList = [{"a":["dfpConfig","loadAds"]},{"a":["adblockDetector"]},{"a":["EventTarget.prototype.addEventListener","window.TextDecoder"]}];

const hostnamesMap = new Map([["gamer.no",0],["tu.no",0],["tv2.no",1],["bold.dk",2]]);
